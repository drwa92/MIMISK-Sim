...
public static class MIMISKDroneAquaLocPaperGpsV7Profile
{
    [MenuItem("MIMISK/Drone/Localization/Apply Profile/Paper-Equivalent GPS v7.1 Publication Output")]
    public static void ApplyPaperGpsV7()
    {
        ...
        SetBool(so, "enableOutputSmoothing", false);
        ...
        // v7 novelty: adaptive lead learned online from GNSS innovation and velocity.
        SetBool(so, "enableAdaptiveHorizontalLead", true);
        SetFloat(so, "adaptiveHorizontalLeadSeconds", 0.65f);
        SetFloat(so, "minAdaptiveHorizontalLeadSeconds", 0.65f);
        SetFloat(so, "maxAdaptiveHorizontalLeadSeconds", 0.65f);
        SetFloat(so, "adaptiveLeadLearningRate", 0.02f);
        ...
        Debug.Log("[MIMISK] Applied AquaLoc Paper-Equivalent GPS v7.1 Publication Output profile.");
    }
    ...
    private static void SetFloat(SerializedObject so, string name, float value)
    {
        ...
        else Debug.LogWarning("[AquaLoc v7] Missing float: " + name);
    }
    ...
    private static void SetInt(SerializedObject so, string name, int value)
    {
        ...
        else Debug.LogWarning("[AquaLoc v7] Missing int: " + name);
    }
    ...
    private static void SetBool(SerializedObject so, string name, bool value)
    {
        ...
        else Debug.LogWarning("[AquaLoc v7] Missing bool: " + name);
    }
    ...
    private static void SetObject(SerializedObject so, string name, Object value)
    {
        ...
        else Debug.LogWarning("[AquaLoc v7] Missing object: " + name);
    }
}
